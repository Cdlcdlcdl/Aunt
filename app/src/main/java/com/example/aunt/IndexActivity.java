...
public class IndexActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       // bt2=(Button)findViewById(R.id.out);
        ...
        final Request request2=new Request.Builder().addHeader("cookie",session).url("http://47.101.204.40:8080/app_housework/worker_infor").build();
        ...
        call2.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        mess.setText(mine.getWorkerName() );
        ...
        final Request request_un=new Request.Builder().addHeader("cookie",session).url("http://47.101.204.40:8080/app_housework/worker_unorders").build();
        ...
        final Request request_ing=new Request.Builder().addHeader("cookie",session).url("http://47.101.204.40:8080/app_housework/worker_orderings").build();
        ...
        call_ing.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
               ...
               // Log.e("1111111111",res);
             //   Log.e("Ordering1",String.valueOf(ordering1.size())+" "+ordering1.get(0).getPredictTime().toString());
            }
        });
        ...
        final Request request_ed=new Request.Builder().addHeader("cookie",session).url("http://47.101.204.40:8080/app_housework/worker_ordereds").build();
        ...
        final Request request_re=new Request.Builder().addHeader("cookie",session).url("http://47.101.204.40:8080/app_housework/worker_removeOrders").build();
